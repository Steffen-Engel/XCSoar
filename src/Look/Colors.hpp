...
static constexpr Color COLOR_XCSOAR_LIGHT = Color(0xff, 0xef, 0x9d);
static constexpr Color COLOR_XCSOAR = Color(0xd8, 0x94, 0x00);
static constexpr Color COLOR_XCSOAR_DARK = Color(0x35, 0x00, 0x35);
#else
