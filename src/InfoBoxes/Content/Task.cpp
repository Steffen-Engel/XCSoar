 ...
 */
void
InfoBoxStartlineDistance::Update(InfoBoxData &data)
{
  data.SetCustom();
}
 ...
 */
void
InfoBoxStartlineDistance::OnCustomPaint(Canvas &canvas, const PixelRect &rc)
{
#define ALT_RED 0
...
UpdateInfoBoxClimbAltitude(InfoBoxData &data)
{
  ...
  // average climb
  data.SetValue(_T("%4.0f"), expectaltitude);
