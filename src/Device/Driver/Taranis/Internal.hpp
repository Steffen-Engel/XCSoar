...
#ifndef INTERNAL_TARANIS_HPP
#define INTERNAL_TARANIS_HPP

#include "Device/Driver.hpp"
#include "Device/Driver/Taranis/Taranis.h"

class TaranisDevice : public AbstractDevice {
private:
  cTaranis Taranis;
