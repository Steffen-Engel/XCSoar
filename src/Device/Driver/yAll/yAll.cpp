...
void cyAll::StartLog(void)
{
  ...
  if (writer->IsOpen())
  {
//            writer.FormatLine("Acro Logfile at %02u.%02u.%04u  %02u:%02u:%02u",
//                              dt.day, dt.month, dt.year,
//                              dt.hour, dt.minute, dt.second);
    writer->WriteLine("date, time, time/msec, nx/g, ny/g, nz/g, phi, psi, theta, rot_x/°/sec, rot_y/°/sec, rot_z/°/s, p_cabin/Pa, p_stat/Pa, p_diff/Pa,eta_hr, eta_qr, eta_sr, eta_fl, GPS_FIX, numSat, GPS_altitude, GPS_speed, longitude, latitude"
                      );
    writer->Flush();
  }
  else
...
//                                                      kalman_filter_static.GetXVel()));
      ...
      if (flying)
      {
        if (writer->IsOpen())
        {
          writer->FormatLine("%02d.%02d.%04d,%02d:%02d:%02d.%d,%8ld,%4d,%4d,%4d,%4d,%4d,%4d,%4d,%4d,%4d,%6d,%6d,%5d,%4d,%4d,%4d,%4d,%1d,%2d,%5d,%6d,%9ld,%9ld",
