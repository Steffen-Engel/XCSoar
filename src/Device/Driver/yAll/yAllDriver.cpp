...
bool
yAllDevice::DataReceived(const void *_data, size_t length,
...
bool
yAllDevice::EnableNMEA(OperationEnvironment &env)
{
...
static Device *
yAllCreateOnPort(const DeviceConfig &config, Port &com_port)
{
